...
//export const SumFacturaContext = createContext({});
...
export function DetalleOP({ idSociety, loggedUser }) {
  ...
  const [sumFactura, setSumFactura] = useState(dataOP? dataOP.monto:0);


  return (   
    <SumFacturaContext.Provider value={[sumFactura, setSumFactura]}>
