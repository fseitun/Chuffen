...
function columns(rubros, changeProveedor) {
  return [
...
export function GrillaProveedores({ idSociety }) {
  ...
  //   getMethod(`subrubro/listar/${idSociety.id}`)
  // );
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <DataGrid
        ...
        columns={columns(rubros, changeProveedor)}
        pageSize={100}
...
function ComboBox({ rubros, props }) {
  ...
  //console.log('props que recibe el combo', props);
  rubros = [
    ...rubros,
    {
      rubro: '',
  ...
  // console.log('state rubro', selectedRubro);
  return (
    <Autocomplete
      value={selectedRubro}
      onChange={async (event, newValue) => {
        ...
        // console.log(
        //   'valores que usa el api (id, field, rubro)',
        //   id,
        //   field,
        //   newValue.rubro
        // );
